...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="view/image/momoIcon.png" href="/home?phoneNumber=${userMomo.getPhoneNumber()}" alt="Momo Icon" width="30" height="30" class="d-inline-block align-text-top">
            Momo
        </a>
...
<div id="carouselDarkVariant" class="carousel slide carousel-fade carousel-dark" data-mdb-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="view/image/momoqc2.png" class="d-block w-100" alt="Quang cao 1"/>

        </div>

        <!-- Single item -->
        <div class="carousel-item">
            <img src="view/image/momoqc1.png" class="d-block w-100" alt="Quang cao 2"/>

        </div>

        <!-- Single item -->
        <div class="carousel-item">
            <img src="view/image/momoqc3.png" class="d-block w-100" alt="Quang cao 3"/>
...
<div class="content">
    ...
    <img src="view/image/momo1.png" class="rounded mx-auto d-block" width="100%" alt="...">
    <img src="view/image/momo3.png" class="rounded mx-auto d-block" width="100%" alt="...">
    <img src="view/image/momo2.png" class="rounded mx-auto d-block" width="100%" alt="...">
