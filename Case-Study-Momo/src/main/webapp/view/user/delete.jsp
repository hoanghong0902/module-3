                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
                       id="navbarDropdownMenuLink" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
                        <img src="https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den-599x600.png"
                             class="rounded-circle" height="30" alt="Portrait of a Woman" loading="lazy"/>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            <a class="dropdown-item"
                               href="/profile?action=showProfile&phoneNumber=${userMomo.getPhoneNumber()}">Xem
                                thông
                                tin</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                               href="/profile?action=edit&phoneNumber=${userMomo.getPhoneNumber()}">Chỉnh sửa</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                               href="/profile?action=delete&phoneNumber=${userMomo.getPhoneNumber()}">Xóa tài
                                khoản</a>
                        </li>
                        <li>
...
<div class="container" id="profile">
    <form action="/profile?action=delete&phoneNumber=${userMomo.getPhoneNumber()}" method="post">
        <div class="row mb-3">
            <h1 class="text-center">Thông tin ví Momo</h1>
        </div>
        <div class="row">
            <div class="col-sm-3">
                <p class="mb-0">Tên</p>
            ...
            <div class="col-sm-9">
                <p class="text-muted mb-0">
                    <c:out value="${userMomo.getUsername()}"/>
                </p>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <p class="text-muted mb-0">
                    <c:out value=" ${userMomo.getBankAccountNumber()}"/>
                </p>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <hr>
            <h3 class="text-center mt-3">Bạn có chắc muốn xóa tài khoản</h3>
            <div class="col-sm-4"></div>
            <div class="col-sm-4">
                <button type="submit" class="btn btn-primary btn-block mb-4 mt-3">Xóa tài khoản</button>
            </div>
        </div>
    </form>
</div>
        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <p>
                        Với hàng trăm tính năng, bạn có thể thực hiện mọi nhu cầu cuộc sống với siêu ứng dụng MoMo:
                        Chuyển tiền, Gửi tiết kiệm, Vay nhanh, Đặt vé du lịch, Mua vé xem phim, Quyên góp, Mua sắm
                        thanh toán…
